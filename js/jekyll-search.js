!function e(t, n, r) {
    ...
    2: [function (require, module, exports) {
        ...
        function setOptions(_opt) {
            opt = _opt || {}, opt.fuzzy = _opt.fuzzy || !1, opt.limit = _opt.limit || 10, opt.searchStrategy = require(_opt.fuzzy ? "./SearchStrategies/FuzzySearchStrategy" : "./SearchStrategies/LiteralSearchStrategy")
        }
        ...
        var data = [], opt = {};
        opt.fuzzy = !1, opt.limit = 10, opt.searchStrategy = require(opt.fuzzy ? "./SearchStrategies/FuzzySearchStrategy" : "./SearchStrategies/LiteralSearchStrategy")
    ...
    5: [function (require, module, exports) {
        ...
        module.exports = {render: render, setOptions: setOptions};
        var opt = {};
        ...
        !function (window, document, undefined) {
            ...
            function registerInput() {
                opt.searchInput.addEventListener("keyup", function (e) {
                    return 0 == e.target.value.length ? void emptyResultsContainer() : void render(store.search(e.target.value))
                })
            }
            ...
            var templater = require("./Templater"), store = require("./Repository"),
                jsonLoader = require("./JSONLoader"), requiredOptions = ["searchInput", "resultsContainer", "json"],
                opt = {
                    searchInput: null,
            ...
            window.SimpleJekyllSearch = function (_opt) {
                opt = validateOptions(_opt), store.setOptions(_opt), isJSON(opt.json) ? initWithJSON(opt.json) : initWithURL(opt.json)
